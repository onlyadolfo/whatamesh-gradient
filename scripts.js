const heroHeader = document.querySelector(".hero-title");
const heroHeaderOverlay = document.querySelector(".hero-header[data-overlay]");
const subHeading = document.querySelector(".sub-heading");
const subHeadingOverlay = document.querySelector(".sub-heading[data-overlay]");
